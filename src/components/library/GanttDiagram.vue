...
<template>
	<GanttChart theme="light" :autoSortByStartDate=true :tasks="progressStore.tasksAsTree" locale="en-US"
		...
		@task-collapse-change="handleTaskCollapseChange" @taskbar-drag-end="handleTaskbarDragEnd"
		@taskbar-resize-end="handleTaskbarResizeEnd" @task-deleted="handleTaskDeleted" :allowDragAndResize=true
		pendingTaskBackgroundColor="#2c687d" completeTaskBackgroundColor="#819098" delayTaskBackgroundColor="#dc2828"
